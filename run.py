...
root = tk.Tk()
app = SoundBoard(root)
mbox.showinfo("ライセンスについて", "TeaChimerはオープンソースソフトウェアであり、GNU General Public License v3.0に基づいて再配布したり改変したりできます。\n©️ 2023 Contributors to the TeaChimer project.\nまた、このプログラムに付属している音声データは、VOICEVOXで作成したずんだもんの音声を使用しています。")
