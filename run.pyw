...
class Main():
    ...
    def main(self):
        ...
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 0, column = 0, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 0, column = 1, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 0, column = 2, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 0, column = 3, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 0, column = 4, padx = 5, pady = 5, sticky = "nsew")

        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 1, column = 0, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 1, column = 1, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 1, column = 2, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 1, column = 3, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 1, column = 4, padx = 5, pady = 5, sticky = "nsew")

        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 2, column = 0, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 2, column = 1, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 2, column = 2, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 2, column = 3, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 2, column = 4, padx = 5, pady = 5, sticky = "nsew")

        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 3, column = 0, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 3, column = 1, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 3, column = 2, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 3, column = 3, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 3, column = 4, padx = 5, pady = 5, sticky = "nsew")

        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 4, column = 0, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 4, column = 1, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 4, column = 2, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 4, column = 3, padx = 5, pady = 5, sticky = "nsew")
        ttk.Button(main, text = "", state = "", command = lambda: self.confirm("", "./system/sample.wav"), style = "TButton").grid(row = 4, column = 4, padx = 5, pady = 5, sticky = "nsew")
